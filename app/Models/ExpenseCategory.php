...
class ExpenseCategory extends Model
{
    ...
    /**
     * Set amount_last_month attribute to get total expense amount in the last month
     * for current expense category.
     *
     * @return int
     */
    public function getAmountLastMonthAttribute()
    {
        return $this->expenses()->where('created_at', '>=', Carbon::now()->subMonth())->sum('amount');
    }
