...
trait HasSubscriptions
{
     ...
     *
     * @return null|\App\Models\PlanSubscription
     */
    ...
    public function newSubscription($subscription, Plan $plan, $dont_start = false): PlanSubscription
    {
        ...
        // Record usages
        /* $subscription->recordFeatureUsage('customers', 0);
        $subscription->recordFeatureUsage('products', 0);
        $subscription->recordFeatureUsage('estimates_per_month', 0);
        $subscription->recordFeatureUsage('invoices_per_month', 0); */
