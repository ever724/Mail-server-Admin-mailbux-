...
use App\Services\QueryBuilder\Exceptions\InvalidDirection;
use App\Services\QueryBuilder\Sorts\Sort;
use App\Services\QueryBuilder\Sorts\SortsField;

class AllowedSort
{
    /** @var \App\Services\QueryBuilder\Sorts\Sort */
    protected $sortClass;
