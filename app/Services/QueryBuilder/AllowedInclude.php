...
use App\Services\QueryBuilder\Includes\IncludedCount;
use App\Services\QueryBuilder\Includes\IncludedRelationship;
use App\Services\QueryBuilder\Includes\IncludeInterface;
...
class AllowedInclude
{
    ...
    {
        $internalName = Str::snake($internalName ?? $name);
