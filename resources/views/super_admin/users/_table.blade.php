    ...
    <table class="table mb-0 thead-border-top-0 table-striped">
        <thead>
            <tr>
                ...
                <th class="w-50px">{{ __('messages.login') }}</th>
            </tr>
        </thead>
        <tbody class="list" id="users">
            ...
            <tr>
                ...
                <td><a href="{{ route('super_admin.users.impersonate', $user->id) }}" class="btn btn-sm btn-link"><i class="material-icons icon-16pt">input</i></a> </td>
            </tr>
            @endforeach
        </tbody>
    </table>
