<div class="card card-form">
    <div class="row no-gutters">
        <div class="col-lg-4 card-body">
            <p><strong class="headings-color">{{ __('messages.paddle_settings') }}</strong></p>
        </div>
        <div class="col-lg-8 card-form__body card-body">
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="form-group required">
                        <label for="paddle_vendor_id">{{ __('messages.paddle_vendor_id') }}</label>
                        <input name="paddle_vendor_id" type="text" class="form-control" placeholder="{{ __('messages.paddle_vendor_id') }}" value="{{ get_system_setting('paddle_vendor_id') }}">
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="form-group required">
                        <label for="paddle_vendor_auth_code">{{ __('messages.paddle_vendor_auth_code') }}</label>
                        <input name="paddle_vendor_auth_code" type="text" class="form-control" placeholder="{{ __('messages.paddle_vendor_auth_code') }}" value="{{ get_system_setting('paddle_vendor_auth_code') }}">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="paddle_sandbox">{{ __('messages.test_mode') }}</label>
                        <select name="paddle_sandbox" class="form-control">
                            <option value="0" {{ get_system_setting('paddle_sandbox') == false ? 'selected' : '' }}>{{ __('messages.false') }}</option>
                            <option value="1" {{ get_system_setting('paddle_sandbox') == true  ? 'selected' : '' }}>{{ __('messages.true') }}</option>
                        </select>
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="paddle_active">{{ __('messages.active') }}</label>
                        <select name="paddle_active" class="form-control">
                            <option value="0" {{ get_system_setting('paddle_active') == false ? 'selected' : '' }}>{{ __('messages.disabled') }}</option>
                            <option value="1" {{ get_system_setting('paddle_active') == true  ? 'selected' : '' }}>{{ __('messages.active') }}</option>
                        </select>
                    </div>
                </div>
            </div>
