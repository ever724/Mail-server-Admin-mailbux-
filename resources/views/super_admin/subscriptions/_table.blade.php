            ...
            <tbody class="list" id="subscriptions">
                @foreach ($subscriptions as $subscription)
                    <tr>
                        ...
                        <td class="text-right"><a href="{{ route('payment.subscription.cancel',[$subscription->client, $subscription]) }}" class="btn btn-sm btn-link delete-confirm"><i class="material-icons icon-16pt">close</i></a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
