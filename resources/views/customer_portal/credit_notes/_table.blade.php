        ...
        <table class="table table-xl mb-0 thead-border-top-0 table-striped">
            ...
            <tbody class="list" id="credit_notes">
                @foreach ($credit_notes as $credit_note)
                    <tr>
                        <td class="h6">
                            <a href="{{ route('customer_portal.credit_notes.details', [$currentCustomer->uid, $credit_note->uid]) }}">
                        ...
                        <td class="h6">
                            <a href="{{ route('customer_portal.credit_notes.details', [$currentCustomer->uid, $credit_note->uid]) }}" class="btn btn-sm btn-link">
